...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'al_nombres',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'al_nombres'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'al_apellidos'); ?>
		<?php echo $form->textField($model,'al_apellidos',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'al_apellidos'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'al_mail'); ?>
		<?php echo $form->textField($model,'al_mail',array('size'=>50,'maxlength'=>50)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'al_preferencia'); ?>
		<?php echo $form->textField($model,'al_preferencia',array('size'=>60,'maxlength'=>600)); ?>
		<?php echo $form->error($model,'al_preferencia'); ?>
	</div>
